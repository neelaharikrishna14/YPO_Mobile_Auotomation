...
namespace ApplicationName.Automation.Tests.TestScripts
{
    ...
    [Script("Claims", "ClaimCenter", "", "Mobile", "Validate Claim Center")]
    public class TC001_VerifyLoginFunctionality : BaseTest
    {
        protected override void ExecuteTestCase()
        {
            Reporter.Add(new Chapter("Validate Claim Center"));
