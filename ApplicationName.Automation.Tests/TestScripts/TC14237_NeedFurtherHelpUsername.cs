...
namespace ApplicationName.Automation.Tests.TestScripts
{
    ...
    [Script("Iteration_2", "US5409 - NeedFurtherHelpUsername", "", "Mobile", "To verify the options displayed in Need Further Help? screen  from Username Recovery page")]
    class TC14237_NeedFurtherHelpUsername : BaseTest
    {
        protected override void ExecuteTestCase()
        {
            ...
            Step = "Click on Forgot Username? link";
